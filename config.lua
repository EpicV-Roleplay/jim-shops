...
Config.Products = {
    ["normal"] = {
		...
		[6] = { name = "lambrusco", price = 3, amount = 50, info = {} },
        [7] = { name = "sandwich", price = 2, amount = 50, info = {} },
        [8] = { name = "beer", price = 7, amount = 50, info = {} },
        [9] = { name = "whiskey", price = 10, amount = 50, info = {} },
        [10] = { name = "vodka", price = 12, amount = 50, info = {} },
	...
	["lspark"] = {
        [1] = { name = "water_bottle", price = 8, amount = 10, info = {} },
        [2] = { name = "kurkakola", price = 12, amount = 10, info = {} },
        [3] = { name = "twerks_candy", price = 7, amount = 10, info = {} },
        [4] = { name = "snikkel_candy", price = 7, amount = 10, info = {} },
        [5] = { name = "lighter", price = 5, amount = 10, info = {} },
		[6] = { name = "redwoodcigs", price = 25, amount = 10, info = {} },
		[7] = { name = "popdonut", price = 15, amount = 10, info = {} },
    },
    ["hardware"] = {
...
--[[     ["weedshop"] = {
	...
	["electronics"] = {
        ...
        [2] = { name = "radio", price = 250, amount = 1, },
...
--[[	["casino"] = {
	...
	["lspark"] = {
		...
		["logo"] = "https://static.wikia.nocookie.net/gtawiki/images/b/b5/DigitalDen-GTAV-Logo.png",
		["coords"] = { 
			vector4(188.3, -918.95, 31.43, 316.83),
			},
		["products"] = Config.Products["lspark"],
		["blipsprite"] = 628,
		["blipcolour"] = 2,
	},
	-- ["seeddealer"] = {
